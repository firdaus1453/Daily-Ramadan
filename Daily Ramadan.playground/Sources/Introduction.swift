...
public class Introduction: UIView {
    ...
    func setupUI() {
        ...
        This playground is designed and developed to inform users about what activity we do if we fasting in Ramadhan, from dawn to sunset, so that we can find out the experiences of our friends who are fasting, more than 1.5 billion Muslims from around the world.
